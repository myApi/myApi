...
class MyapiViewShare extends JView {
    function display($tpl = null) {
       	JPlugin::loadLanguage( 'plg_content_myapishare' , JPATH_ADMINISTRATOR );
		
		
		$db = JFactory::getDBO();
		$query = "SELECT id FROM #__plugins WHERE element =".$db->quote('myApiShare');
		$db->setQuery($query);
		$id = $db->loadResult();
