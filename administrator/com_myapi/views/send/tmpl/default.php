...
?>
  ...
  <form action="index.php" method="post" name="adminForm">
	...
	<table width="100%">
	<tr>
	<td><p>From here you can adjust the settings for the send buttons. You'll need to click save to apply these default settings if this is the first time you have installed myApi</p></td>
	</tr>
    <tr>
