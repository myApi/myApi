...
class JFormFieldColor extends JFormField{
	protected function getInput(){
		...
		if(!$embedded){
			$js = "window.addEvent('domready',function(){
					...
					$$('.rainbowbtn').each(function(item){
						item.color=new MooRainbow(item.id, {
							...
							imgPath: '".JURI::root()."modules/mod_myapi_fbRecommendations/elements/moorainbow/images/'
						});
					});
				});";
			...
			$document->addScript(JURI::root()."modules/mod_myapi_fbRecommendations/elements/moorainbow/mooRainbow.js");
			$document->addStyleSheet(JURI::root()."modules/mod_myapi_fbRecommendations/elements/moorainbow/mooRainbow.css");
			$embedded=true;
		} 
