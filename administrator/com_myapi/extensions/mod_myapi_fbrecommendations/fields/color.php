	...
	protected function getInput(){
		...
		$js = "window.addEvent('domready',function(){
				var r = new MooRainbow('".$this->name."', { 
					imgPath: '".JURI::root()."modules/mod_myapi_fbRecommendations/fields/moorainbow/images/',
		...
		$document->addScript(JURI::root()."modules/mod_myapi_fbRecommendations/fields/moorainbow/mooRainbow.js");
		$document->addStyleSheet(JURI::root()."modules/mod_myapi_fbRecommendations/fields/moorainbow/mooRainbow.css");
