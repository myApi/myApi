...
class JFormFieldColor extends JFormField{
	protected function getInput(){
		...
		$document->addScript(JURI::root()."modules/mod_myapi_fbActivity/fields/moorainbow/mooRainbow.js");
		$document->addStyleSheet(JURI::root()."modules/mod_myapi_fbActivity/fields/moorainbow/mooRainbow.css");
