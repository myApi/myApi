...
<div class="<?php echo $params->get('moduleclass_sfx'); ?>">
	<fb:activity border_color="<?php echo $border; ?>" colorscheme="<?php echo $scheme; ?>" header="<?php echo $header; ?>" width="<?php echo $width; ?>" height="<?php echo $height; ?>" font="<?php echo $font; ?>"></fb:activity>
</div>
